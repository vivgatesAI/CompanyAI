...
const ORDER_STORAGE_KEY = "companyai.companyOrder";
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      ...
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <img src="/companyai-logo.png" alt="CompanyAI" className="h-7 w-7 object-contain" onError={(e) => {
          const img = e.currentTarget as HTMLImageElement;
          img.style.display = "none";
          const sibling = img.nextElementSibling as HTMLElement | null;
          if (sibling) sibling.style.display = "inline-flex";
        }} />
        <span className="hidden items-center justify-center"><Building2 className="h-5 w-5 text-foreground" /></span>
      </div>
